...
const HIGHLIGHTER = {
  ...
  donating: `${img} ${text} ${block} lg:bg-[length:820.72px_76.43px] lg:text-[49px] md:bg-[length:571.49px_53.22px] md:text-[34.2499px] sm:bg-[length:339.1px_31.58px] sm:text-[20.3228px]`,
}
