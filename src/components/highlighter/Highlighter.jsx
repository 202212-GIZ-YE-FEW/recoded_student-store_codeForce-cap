...
const block = "block"
const smSize = "lg:bg-[length:437.27px_38px] lg:text-[38px]"
const lgSize = ""
const HIGHLIGHTER = {
  ...
  productListing: `${img} ${text} md:${block} ${smSize} md:bg-[length:334.85px_30px] md:text-[30px] hidden`,
  ...
  ordersPage: `${img} ${text} ${block} ${smSize} md:bg-[length:313.92px_27.28px] md:text-[27px] bg-[length:233.67px_20.31px] text-[21px]`,
