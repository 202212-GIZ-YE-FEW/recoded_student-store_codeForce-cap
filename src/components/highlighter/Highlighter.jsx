...
const HIGHLIGHTER = {
  ...
  ordersPage: `${img} block ${lgSize} ${mdSize} ${smSize}`,
  listingPage: `${img} block ${mdSize} ${smSize} lg:bg-[length:200px_38px] lg:text-[38px]`,
  editProfile: `${img} block ${mdSize} ${smSize} lg:bg-[length:200px_38px] lg:text-[30px]`,
